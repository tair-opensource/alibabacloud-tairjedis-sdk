...
//    }
     ...
     * @return Success: OK; Fail: error.
     */
    public Response<String> sketchesBatchWrite(final ArrayList<CpcArrayMultiData> keys) throws JedisConnectionException,IllegalArgumentException, JedisDataException {
