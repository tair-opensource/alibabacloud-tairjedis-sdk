...
public class TairVectorTest extends TairVectorTestBase {
    ...
    public void tvs_hmgetall() {
        ...
        List<byte[]> entity_byte = tairVector.tvshmget(SafeEncoder.encode(index), SafeEncoder.encode("first_entity_knn"),
    ...
    public void tvs_mknnsearch() {
        ...
        Collection<VectorBuilderFactory.Knn<byte[]>> result_byte = tairVector.tvsmknnsearch(SafeEncoder.encode(index), topn,
    ...
    public void tvs_mknnsearch_filter() {
        ...
        Collection<VectorBuilderFactory.Knn<byte[]>> result_byte = tairVector.tvsmknnsearchfilter(SafeEncoder.encode(index),
