...
tairjedis-sdk是基于[Jedis](https://github.com/xetorthio/jedis)封装的，操作[云数据库Redis企业版](https://help.aliyun.com/document_detail/146579.html) 的客户端，主要包含下列功能：

- 支持企业版多种[Module](https://help.aliyun.com/document_detail/146579.html)的操作命令
- 支持集群直连模式下mset/mget/del命令【未完成】
...
最新版本查阅：[这里](http://repo.alibaba-inc.com/nexus/index.html#nexus-search;quick~tairjedis-sdk)
...
加锁：redis set with nx，and expiretime
解锁：cad(compare and delete)
```
...
将学生信息存储为JSON格式，直接通过path更新部分JSON对象。
```
